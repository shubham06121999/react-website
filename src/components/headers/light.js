...
export default ({ roundedHeaderButton = false, logoLink, links,logo, logoText,className, collapseBreakpointClass = "lg" }) => {
  /*
  ...
  const defaultLinks = [
    <NavLinks key={1}>
      <NavLink href="/#" css={location.pathname === '/#' && activeLinkStyle}>About</NavLink>
      <NavLink href="/#" css={location.pathname === '/#' && activeLinkStyle} >Blog</NavLink>
      <NavLink href="/#" css={location.pathname === '/#' && activeLinkStyle}>Pricing</NavLink>
      <NavLink href="/#" css={location.pathname === '/#' && activeLinkStyle}>Contact Us</NavLink>
      <NavLink href="/#"  css={location.pathname === '/#' && activeLinkStyle} tw="lg:ml-12!">
        Login
      </NavLink>
  ...
  logoText =  'Sencilla Consultancy Services';
